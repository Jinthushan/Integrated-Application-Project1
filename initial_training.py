...
sen_pred_lr = log_model.predict(review_test_vec)
...
print("Logistic Regression Accuracy:", accuracy_score(sen_test, sen_pred_lr))
print(classification_report(sen_test, sen_pred_lr))
